...
**What you can verify:**
- Edge Appliance software (`view-guard-edge`) - runs entirely on your hardware
- Encryption libraries (`view-guard-crypto`) - client-side encryption and decryption
- Wire protocols (`view-guard-proto`) - communication contracts between components
...
- Initialize public submodules (edge, crypto, proto)
...
- **[view-guard-edge](https://github.com/yourorg/view-guard-edge)** - Edge Appliance software
...
- **[view-guard-crypto](https://github.com/yourorg/view-guard-crypto)** - Encryption libraries
  - AES-256-GCM encryption
  - Argon2id key derivation
  - Browser-based decryption
  - License: Apache 2.0

- **[view-guard-proto](https://github.com/yourorg/view-guard-proto)** - Protocol definitions
...
- **view-guard-kvm-agent** - Production KVM VM agent (Filecoin, quotas, WebRTC)
- **view-guard-saas-backend** - SaaS Control Plane backend (billing, provisioning)
- **view-guard-saas-frontend** - SaaS Control Plane frontend (React UI)
- **view-guard-infra** - Infrastructure as Code (Terraform, K8s)
...
- **[PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md)** - Repository organization and structure

## Self-Hosting

You can self-host the Edge Appliance and use your own KVM VM or storage backend. See the public repositories for:

- Edge Appliance installation and configuration
- Protocol specifications for building custom integrations
- Encryption library usage for client-side decryption
...
- Edge Appliance improvements
- Encryption library enhancements
...
- **Issues**: Open issues in the relevant repository
