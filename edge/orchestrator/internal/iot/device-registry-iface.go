...
//
//go:generate go run go.uber.org/mock/mockgen -destination=mocks/mock_device_registry.go -package=mocks github.com/vzahanych/view-guard-meta/edge/orchestrator/internal/iot DeviceRegistry
